...
@implementation NSData (YM_GZIP)

- (NSData *)ym_gzippedDataWithCompressionLevel:(float)level
{
    if (self.length == 0 || [self ym_isGzippedData]) {
        return self;
    }

    void *libz = ym_libzOpen();
...
- (NSData *)ym_gzippedData
{
    return [self ym_gzippedDataWithCompressionLevel:-1.0f];
}

- (BOOL)ym_isGzippedData
{
