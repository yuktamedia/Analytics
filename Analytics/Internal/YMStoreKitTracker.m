...
@interface YMStoreKitTracker ()

@property (nonatomic, readonly) YMAnalytics *analytics;
...
@implementation YMStoreKitTracker

+ (instancetype)trackTransactionsForAnalytics:(YMAnalytics *)analytics
{
    return [[YMStoreKitTracker alloc] initWithAnalytics:analytics];
}
